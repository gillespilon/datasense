...
def dataframe_info(
    ...
    string_not_list print_list_by_item(list=columns_bool_list)
    print()
    print(f'List of {columns_category_count} category columns:')
    string_not_list print_list_by_item(list=columns_category_list)
    print()
    print(f'List of {columns_datetime_count} datetime columns:')
    string_not_list print_list_by_item(list=columns_datetime_list)
    print()
    print(f'List of {columns_float_count} float columns:')
    string_not_list print_list_by_item(list=columns_float_list)
    print()
    print(f'List of {columns_integer_count} integer columns:')
    string_not_list print_list_by_item(list=columns_integer_list)
    print()
    print(f'List of {columns_object_count} string columns:')
    string_not_list print_list_by_item(list=columns_object_list)
    print()
    print(f'List of {columns_timedelta_count} timedelta columns:')
    string_not_list print_list_by_item(list=columns_timedelta_list)
    print()
    print(f'List of {columns_empty_count} empty columns:')
    string_not_list print_list_by_item(list=columns_empty_list)
    print()
    return df
