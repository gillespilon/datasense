...
def test_one_sample_t():
    ...
    0.9746973097386498, 0.7642839483945643, 0.2270875306568172,
    0.703, 0.1009686916604779, 0.7255204234760189,
    266.91858206241807, 394.20141793758194
)
...
def test_two_sample_t():
    ...
    expected = (
        ...
        0.9785249763729523, 0.9574032744427222, 0.8853149752492473,
        0.17846557720076883, 3.2744574205759416, 0.07036619072494953,
        0.15265397324961683, 0.68, 0.49940696863048295,
        0.693, 0.06234516845619442, 7.67502856891755
    )
    assert result == expected
    result = ds.two_sample_t(
        series1=series1_two_sample_t,
...
def test_paired_t():
    ...
    expected = (
        ...
        0.9718569087171878, 0.7935152200395024,
        0.33171651643374744, 0.692,
        0.14709700945048904, 0.3071349516596349,
        0.6770122524449045, 3.722987747555096
    )
    assert result == expected
    result = ds.paired_t(
        series1=series1_paired,
    ...
    expected = (
        ...
        0.33171651643374744, 0.692,
        0.14709700945048904, 0.3071349516596349,
        0.9417975057209451, 3.458202494279055
    )
    assert result == expected
    result = ds.paired_t(
        series1=series1_paired,
