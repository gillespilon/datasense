...
def test_one_sample_t():
    ...
    # expected = (
    # t statistic, t p value, t power, Shapiro-Wilk statistic, Shapiro-Wilk
    # p value, Anderson-Darling statistic, Anderson-Darling critical value for
    # alpha 0.05, Kolmogorov-Smirnov statistic, Kolmogorov-Smirnov p value,
